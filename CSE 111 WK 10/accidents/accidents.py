"""This code calculates the number of injuries and deaths for the years 2010 - 2017 
if cell phone use had been reduced by the given percentage input (i.e. if cell phone use 
were reduced by "x percent" in the year 2010 there would have been "y" amount of fewer inuries and deaths.)"""

# Import the csv module so that it can be used to read from the accidents.csv file.
import csv
